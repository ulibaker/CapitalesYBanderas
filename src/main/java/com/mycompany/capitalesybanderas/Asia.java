...
public class Asia extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Asia.class.getName());
    ...
    public Asia() {
        ...
        getContentPane().setBackground(new java.awt.Color(200, 200, 100));
        ImageIcon icono = new ImageIcon(getClass().getClassLoader().getResource("0.png"));
        setIconImage(icono.getImage());
        
        mapaBanderas.put(1, new String[]{"Rusia", "Moscu"});
        mapaBanderas.put(2, new String[]{"Mongolia", "Ulan Bator"});
        mapaBanderas.put(3, new String[]{"China", "Pekin"});
        mapaBanderas.put(4, new String[]{"Nepal", "Katmandu"});
        mapaBanderas.put(5, new String[]{"Butan", "Timbu"});
        mapaBanderas.put(6, new String[]{"India", "Nueva Delhi"});
        mapaBanderas.put(7, new String[]{"Myanmar", "Naipyido"});
        mapaBanderas.put(8, new String[]{"Tailandia", "Bangkok"});
        mapaBanderas.put(9, new String[]{"Laos", "Vientian"});
        mapaBanderas.put(10, new String[]{"Camboya", "Nom Pen"});
        mapaBanderas.put(11, new String[]{"Vietnam", "Hanoi"});
        mapaBanderas.put(12, new String[]{"Filipinas", "Manila"});
        mapaBanderas.put(13, new String[]{"Taiwan", "Taipei"});
        mapaBanderas.put(14, new String[]{"Corea", "Seul"});
        mapaBanderas.put(15, new String[]{"Corea del Norte", "Pyongyang"});
        mapaBanderas.put(16, new String[]{"Japon", "Tokio"});
    ...
    private void initComponents() {
        ...
        HLbl.setForeground(new java.awt.Color(210, 210, 110));
        HLbl.setText("Hola");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Asia().setVisible(true));
    }
